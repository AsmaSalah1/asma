...
<Link className="sendCodeLink" to='/sendCode'>Forget Password ?</Link>
        <button type="submit" className="btn btn-outline-dark s " disabled={loader?'disabled':''}  >{!loader?'Log in':<Loader/>}</button>
      </form>
      </div>
      </div>
      {/* <div className="login-box">
