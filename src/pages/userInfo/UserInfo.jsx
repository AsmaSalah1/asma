...
function UserInfo() {
  ...
  <div className=" d-flex justify-content-center align-items-center ">
      <div className={`card mb-3 h-400 ${style.hei} d-flex justify-content-center align-items-center`} style={{borderRadius: '.5rem'}}>
        <div className="row g-0 ">
          <div className="col-md-6 gradient-custom text-center" style={{borderTopLeftRadius: '.5rem', borderBottomLeftRadius: '.5rem'}}>
